...
<span  class="btn btn-info  text-center col-xs-12 " style="padding:40px 10px 10px 10px; height:150px; ">
    <h3 class="glyphicon glyphicon-book" style="margin-bottom: 0px; margin-top: 0px"></h3>
    <h3>NEW SESSION</h3></span>
</a></div>

<div class=" col-xs-12 col-sm-3">
<a href="find_patient.php">
<span  class="btn btn-warning  text-center col-xs-12 " style="padding:40px 10px 10px 10px; height:150px; ">
    <h3 class="glyphicon glyphicon-folder-open" style="margin-bottom: 0px; margin-top: 0px"></h3>
    <h3>CHECK NOTES</h3></span>
</a></div>
</div>
<div class="row" >
<div class=" col-xs-12 ">
