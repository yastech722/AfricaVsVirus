...
if (isset($_SESSION['username'])) {
    ...
    <div class="row">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="anesthesia.php">Anaesthesia <span class="badge"><?php echo fetch_open_procedures_count(); ?></span></a></li>
        ...
        <table id="example" class="table table-striped table-bordered">
            ...
            <tbody>
                <?php
                $patients = fetch_open_procedures();
                ...
                foreach ($patients as $patient) {
                    ...
                    <tr>
                        ...
                        <?php include 'modals.php';  if ($patient[2] == 0) { ?>
                        
                            <td><a href=""  data-toggle="modal" data-target="#openProcedure<?php echo $patient['procedure_id'] ?>" class="btn btn-primary btn-small">OPEN</a></td>
                        <?php } else { ?> <td><a href="" data-toggle="modal" data-target="#concludeAnesthesia<?php echo $patient['procedure_id'] ?>" class="btn btn-primary btn-small">CONCLUDE</a></td> <?php }
              //  include 'modals.php';   ?>
